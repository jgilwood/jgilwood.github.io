...
Each of these pieces have been spcifically chosen because they carry some sort of personal significance to me. Each of them, in their own way, shifted my view of art as a whole and changed how I went about my own practices of art making and appreciating. Therefore, I felt these ones were right to share in a project reliant on the power of art as an emotional and inspirational tool that carries meaning to induvidual people, both the artists making these works and the audience appreciating them.
...
Rothko's art in general has been a very important factor in the development of my artistic mind/awareness. When I first encountered this piece in a community college Art History class as a senior in high school, I didn't have many positive feelings towards abstract art or "contemporary" art in general. Despite my years of experience with art at the time, I still often found myself holding "snobish" ideas about what was "good art"; however, one look at a Rothko completely chnaged my perspective. I was totally filled with awe, even just looking at his work through a computer screen. I find it hard for me to pick just one Rothko piece to showcase here, but <i>No. 14 1960</i> is a good starting point for anyone not familiar with Rothko's work. While I once percieved abstract art as lacking emotion or as being overly simplistic, with this piece I can tell that Rothko's work is anything but that. The emotions this piece makes me feel defies words, but I will try my best anyways. The visibility of each layer of paint that has been built up creates a profound depth within the piece that feels like it tugs at something deep inside me. Like this piece voices something about myself I could not put into words if I tried. 
...
### Pre-AI Usage Wariness 

Before even attempting to use generative AI, I knew I had my doubts about how this would go. First, I worried about the flashier and mroe well-known faults of AI image generation. In my mind I saw every Twitter post collecting and documenting how much AI art sucked by all technical artistic measures: hands missing fingers or with too many fingers or that simply looked like they've been through a blender, strange artifacting, nonsensical elements to the image appearing and disapearing in odd plaecs (ie the hair). I was worried these images simply wouldn't look *good*. Then I wondered: if these images didn't look good, would that make them carry more or less emotional weight? Good art isn't always technically good, but it still holds something of the artist inside it. The conclusion I would ultimately come to was that it wouldn't matter, other issues I would encounter would far outweigh my worries of poor-technical skills.
...
AI simply isn’t built for this. It isn’t built to make art. It doesn't have the capacity to think about all the little details that come together to make art feel real and significant, it cobbles together what it knows and what its been told with little rhyme or reason or real awareness of what its creating. 

## Creating art with Python Image Library

I knew that this process would be difficult for me since I haven't had much experience with writing code in Python or using Python Image Library (PIL), so, I won't lie, I went with the piece I thought was the most feasible for me to recreate, Rothko's <i>No. 14 1960</i>. In addition to me thinnking I would actually have a chance at capturing the sincerity of the piece, I felt that generative AI did one of the worst jobs with this piece. 
```python
...
This option worked out better for me! I was able to easily set the bounds of each color field/map. I didn't consier this option immediately because I had wanted each color to have it's own Perlin Noise that would be distinct, but I'm still satisfied with this outcome! 
